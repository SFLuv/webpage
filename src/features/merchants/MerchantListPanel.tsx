...
export function MerchantListPanel({
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="hidden shrink-0 flex-col items-center gap-2 border-l border-line bg-surface px-2 py-3 text-ink-subtle transition-colors hover:text-ink lg:flex"
  ...
  return (
    <aside className="hidden w-72 shrink-0 flex-col overflow-hidden border-l border-line bg-surface lg:flex xl:w-80">
      <div className="flex items-center gap-2 border-b border-line p-2.5">
        ...
        <button
          ...
          className="shrink-0 rounded-lg p-1.5 text-ink-subtle transition-colors hover:bg-ink/5 hover:text-ink"
